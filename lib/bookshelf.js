...
(function($) {
    ...
    var currentDemo,
        ...
        samples = {
            'magazine0': {
                'path': 'samples/magazine0/'
            },
           
            'magazine1': {
                'path': 'samples/magazine1/'
            },
            'magazine2': {
                'path': 'samples/magazine2/'
            },
            'magazine3': {
                'path': 'samples/magazine3/'
            },
            'magazine4': {
                'path': 'samples/magazine4/'

            },
            'magazine5': {
                'path': 'samples/magazine5/'

            },
            'magazine6': {
                'path': 'samples/magazine6/'
            },
            'magazine7': {
                'path': 'samples/magazine7/'
            },
            'magazine8': {
                'path': 'samples/magazine8/'
            },
            'magazine9': {
                'path': 'samples/magazine9/'

            },
            'magazine10': {
                'path': 'samples/magazine10/'

            },
            'magazine11': {
                'path': 'samples/magazine11/'
            },
            'magazine12': {
                'path': 'samples/magazine12/'
            },
            'magazine13': {
                'path': 'samples/magazine13/'
            },
            'magazine14': {
                'path': 'samples/magazine14/'

            },
            'magazine15': {
                'path': 'samples/magazine15/'

            },
            'magazine16': {
                'path': 'samples/magazine16/'
            },
            'magazine17': {
                'path': 'samples/magazine17/'
            }
    ...
    $(document).ready(function() {
        ...
        $('.share .icon').bind($.mouseEvents.over, function(e) {
            ...
            var className = $.trim($(this).attr('class').replace(/\b([a-z-]*hover|icon)\b/g, ''));
        ...
        clickElement($('.share .icon'), function(e) {
            ...
            navigation($.trim($(this).attr('class').replace(/\b([a-z-]*hover|icon)\b/g, '')));
